...
**R2-Farmer** мы разработали командой **R² negative** на **Первом городском хакатоне Обнинска 2025**. С этим решением наша команда заняла **3 место** в кейсе № 3 **«AI-анализ здоровья полей по спутниковым снимкам»**.
